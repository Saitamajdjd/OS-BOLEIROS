...
### 5.1. Configurar URL do Site (IMPORTANTE para Deploy Vercel)

Após fazer o deploy na Vercel, você **precisa** configurar as URLs no Supabase:

1. Vá em **Authentication** > **URL Configuration**
2. Configure:
   - **Site URL**: A URL do seu site na Vercel (ex: `https://seu-projeto.vercel.app`)
...
**Nota**: Sem essa configuração, o login pode falhar com "Email ou senha inválidos" mesmo com credenciais corretas.
